...
#     end
  ...
  describe ".average_number_of_rides_with_wind" do
    it "returns .average_number_of_rides_with_wind" do
      setup
      expect(Weather.average_number_of_rides_with_wind).to eql(1)
      end
    end
...
def setup
  ...
  weather_1 = Weather.create(max_temp: 59, min_temp: 40, mean_temp: 45, mean_humidity: 50, mean_visibility_miles: 5, mean_wind_speed: 3, precipitation: 1.5, date: "2012-02-03")
  weather_2 = Weather.create(max_temp: 45, min_temp: 41, mean_temp: 50, mean_humidity: 51, mean_visibility_miles: 4, mean_wind_speed: 1, precipitation: 0.5, date: "2012-02-04")
