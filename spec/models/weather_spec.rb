...
#     end
  ...
  describe ".average_number_of_rides_with_precip" do
    it "returns .average_number_of_rides_with_precip" do
      setup
      expect(Weather.average_number_of_rides_with_precip(0.5, 1.0)).to eql(1)
      end
    end
  ...
  describe ".max_number_rides_with_precip" do
    it "returns .max_number_rides_with_precip" do
      setup
      expect(Weather.max_number_rides_with_precip(0.5, 1.0)).to eql(1)
      end
    end
  ...
  describe ".min_number_rides_with_precip" do
    it "returns .min_number_rides_with_precip" do
      setup
      expect(Weather.min_number_rides_with_precip(0.5, 1.0)).to eql(1)
      end
    end
  #
...
def setup
  ...
  weather_1 = Weather.create(max_temp: 59, min_temp: 40, mean_temp: 45, mean_humidity: 50, mean_visibility_miles: 5, mean_wind_speed: 3, precipitation: 1.0, trip_id: 1, date: "2012-02-04")
  weather_2 = Weather.create(max_temp: 45, min_temp: 41, mean_temp: 50, mean_humidity: 51, mean_visibility_miles: 4, mean_wind_speed: 4, precipitation: 0.5, trip_id: 2, date: "2012-02-04")
  weather_3 = Weather.create(max_temp: 41, min_temp: 51, mean_temp: 50, mean_humidity: 51, mean_visibility_miles: 3, mean_wind_speed: 5, precipitation: 2.5, trip_id: 3, date: "2012-02-04")
  weather_4 = Weather.create(max_temp: 44, min_temp: 41, mean_temp: 50, mean_humidity: 51, mean_visibility_miles: 10, mean_wind_speed: 10, precipitation: 1.5, trip_id: 4,date: "2012-02-04")
