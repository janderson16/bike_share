...
def setup
  ...
  weather_3 = Weather.create(max_temp: 41, min_temp: 51, mean_temp: 50, mean_humidity: 51, mean_visibility_miles: 3, mean_wind_speed: 5, precipitation: 0.5, date: "2012-02-04")
